...
namespace OmniCoin.Wallet.Win.CustomControls
{
    public class ToggleImageButton : ToggleButton
    {
        public ToggleImageButton()
        {
            var resourceLoactor = new Uri("pack://application:,,,/OmniCoin.Wallet.Win;component/CustomControls/ToggleImageButton/ToggleImageButtonStyle.xaml");
