...
using OmniCoin.Wallet.Win.Common.Detects;
using System;
using System.IO;
using System.Linq;
...
namespace OmniCoin.Wallet.Win
{
    ...
    public partial class App : Application
    {
        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            OmniCoinSetting.CurrentNetworkType = netType;
        ...
        {
            var mutexStr = OmniCoinSetting.CurrentNetworkType == NetworkType.Mainnet ? "OmniCoin.Wallet" : "OmniCoin.Wallet(testnet)";
        ...
        private static bool DetectVC2015()
        {
            ...
            if (!result)
            {
                var msgResult = MessageBox.Show("OMC wallet requires to install Visual C++ 2015 Redistributable\r\n download now??", 
        ...
        const string CurrentPackgeName = "OmniCoin-0.0.1-Win.exe";
        const string PackgeNameRegex = @"OmniCoin-.\..\..-Win.exe";
