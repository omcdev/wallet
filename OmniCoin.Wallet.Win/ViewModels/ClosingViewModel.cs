...
namespace OmniCoin.Wallet.Win.ViewModels
{
    public class ClosingViewModel : VmBase
    {
        ...
        void OnClosing(Window window)
        {
            ...
            Logger.Singleton.Debug("Node正常关闭，强杀OmniCoin");
            Environment.Exit(0);
        }
        ...
        void OnRestart(SendMsgData<Window> data)
        {
            ...
            if (OmniCoinSetting.CurrentNetworkType == NetworkType.Mainnet)
        ...
        void KillProcess()
        {
            ...
            var ids = ProcessUtil.Find("dotnet.exe", OmniCoinSetting.NodeRunParams);
