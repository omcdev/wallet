...
using OmniCoin.Wallet.Win.Common.Keys;
using OmniCoin.Wallet.Win.ViewModels;
using System;
...
namespace OmniCoin.Wallet.Win.Common
{
    ...
    public class LanguageService : InstanceBase<LanguageService>
    {
        ...
        private void LoadErrorCodes(LanguageType languageType)
        {
            ...
            string path = string.Format("pack://application:,,,/OmniCoin.Wallet.Win;component/lang/errorcodes/{0}.xaml", name);
            var resourceLoactor = new Uri(path);
